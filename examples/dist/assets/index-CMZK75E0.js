...
`])}function q(t={}){const e=y(""),o=y(25),r=y(!1),n=A(()=>{const m=e();return m?`Hello, ${m}!`:"Enter your name..."}),s=z({email:"",theme:"light",submissions:0});j(s,{key:"lumin-form-demo"});function c(){w(()=>{e(""),o(25),r(!1),s.reset()})}function a(){s.set("submissions",s.get("submissions")+1),console.log("Submitted!",{name:e(),age:o(),accepted:r(),email:s.get("email")})}if(typeof document<"u"){const m="lumix-style-formdemo";if(!document.getElementById(m)){const f=document.createElement("style");f.id=m,f.textContent=`
  .form-demo {
    max-width: 480px;
    margin: 2rem auto;
    padding: 2rem;
...
`,document.head.appendChild(f)}}return i("div",null,[i("div",{class:"form-demo"},[`
  ...
  `]),`
`]),`
`])}function G(t={}){const e=y(0),o=()=>e(e()+1),r=()=>e(e()-1),n="Styled Counter",s=y("blue");if(typeof document<"u"){const c="lumix-style-styledcounter";if(!document.getElementById(c)){const a=document.createElement("style");a.id=c,a.textContent=`
  .counter {
...
`,document.head.appendChild(a)}}return i("div",null,[i("div",{class:"counter"},[`
  ...
  `]),`
`]),`
`])}function U(t={}){const e=y(!1),o=()=>e(!e());if(typeof document<"u"){const r="lumix-style-layoutdemo";if(!document.getElementById(r)){const n=document.createElement("style");n.id=r,n.textContent=`
  .demo {
    max-width: 800px;
    margin: 0 auto;
    padding: 20px;
